...
# ---------------------------------------------------------
# Render Health Check Server (Keep Alive 24/7)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Handlers: Game Modes (eFootball / DLS)
# ---------------------------------------------------------
...
async def handle_mode_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
[9/6/2026 2:41 AM] 💯💥: if query.data == "mode_random":
        keyboard = [
...
[9/6/2026 2:41 AM] 💯💥: join_room_conv = ConversationHandler(
